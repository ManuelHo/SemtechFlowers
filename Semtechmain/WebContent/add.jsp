...
<div class="row">
      ...
      <optgroup label="Tulpen">
       ...
       <optgroup label="Gerbera">
        ...
        <option label="Blaue Gerbera" value="Gerbera,Blau,2.50">Blaue Gerbera</option>
         <option label="Weiﬂe Gerbera" value="Gerbera,Weiss,2.50">Blaue Gerbera</option>
      </optgroup>
      ...
      <br></br>
      <br></br>
<button type="button" name ="add" class="btn btn-primary" onclick="addFlower()">Blume zu Strauﬂ hinzuf¸gen</button>
</div>
</div>
          <div class="col-lg-3">
 <div class="trial">
