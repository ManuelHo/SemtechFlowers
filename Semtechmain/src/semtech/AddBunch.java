...
sb.append("var strUser = e.options[e.selectedIndex].value; var textUser = e.options[e.selectedIndex].text;");
    ...
    sb.append("<h1>  Flowershower</h1> <p class=\"lead\">Der Florist in ihrer Nähe</p>  </div>"
    ...
    sb.append("<optgroup label=\"Rosen\"> <option label=\"Gelbe Rose\" value =\"Rose,Gelb,2.50\">Gelbe Rose</option>"
    		...
    		+ "<option label=\"Weiße Rose\" value=\"Rose,Weiss,2.50\">Blaue Rose</option></optgroup>");
    ...
    sb.append("<optgroup label=\"Lilie\"> "
            ...
            sb.append("<button type=\"button\" name =\"add\" class=\"btn btn-primary\" onclick=\"addFlower()\">Blume zu Strauß hinzufügen</button>");
